...
Ocultar la Consola de Administración (Puerto 9990): Nunca debe estar expuesta a Internet. Se debe configurar para escuchar solo en localhost.

HTTPS: Todo el tráfico debe ir cifrado para evitar el robo de datos o credenciales.

Gestión de Secretos: No incluir contraseñas en el código ni en el Dockerfile. Usar variables de entorno inyectadas en tiempo de ejecución.

Usuario no-root: Ejecutar el contenedor con un usuario limitado para que, si alguien hackea la aplicación, no tenga control total sobre el contenedor o el host.
